...
namespace MVCWebApplication5.Controllers
{
    ...
    {
        private readonly MVCWebApplication5Context _context;

        public UsersController(MVCWebApplication5Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.User != null ? 
                          ...
                          Problem("Entity set 'MVCWebApplication5Context.User'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MVCWebApplication5Context.User'  is null.");
            }
            var user = await _context.User.FindAsync(id);
            if (user != null)
            {
